...
export class AuthService {
  private loginUrl = 'https://django-api.hslab.space/login/';
  private registerUrl = 'https://django-api.hslab.space/register/';
  ...
  private getUserIdFromServer() {
    ...
    this.http.get('https://django-api.hslab.space/user-id/', { headers }).subscribe(
      (response: any) => {
